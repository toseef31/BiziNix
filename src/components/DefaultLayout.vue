<template>
 ...
 <Popover class="relative bg-gray-800">
    <div class="mx-auto max-w-full px-4 sm:px-6">
      <div class="flex items-center justify-between border-b-2 border-gray-800 py-6 md:justify-start md:space-x-10">
        ...
        <div class="-my-2 -mr-2 md:hidden">
          <PopoverButton class="inline-flex items-center justify-center rounded-md bg-teal-600 p-2 text-white hover:bg-gray-100 hover:text-gray-500 focus:outline-none">
        ...
        <PopoverGroup as="nav" class="hidden space-x-6 md:flex">
          <Popover class="relative" v-slot="{ open }">
            <PopoverButton :class="[open ? 'text-gray-400' : 'text-white', 'group inline-flex items-center rounded-md bg-gray-800 text-base font-medium hover:text-gray-400 focus:outline-none']">
              <span>Firmy a ich úprava</span>
              <ChevronDownIcon :class="[open ? 'text-gray-400' : 'text-white', 'ml-2 h-5 w-5 group-hover:text-gray-400']" aria-hidden="true" />
            </PopoverButton>
        ...
        <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
          <router-link v-if="!user.userId" to="/login" class="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-teal-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-teal-700">Prihlásiť sa</router-link>
          ...
          <Menu v-if="user.userId" as="div" class="ml-3 relative">
                <div>
                  ...
                  >
                    ...
                    >
                      <span v-if="user.data.first_name">{{ user.data.first_name[0] }}</span>
                      <span v-else>?</span>
                    </div>
    ...
    <transition enter-active-class="duration-200 ease-out" enter-from-class="opacity-0 scale-95" enter-to-class="opacity-100 scale-100" leave-active-class="duration-100 ease-in" leave-from-class="opacity-100 scale-100" leave-to-class="opacity-0 scale-95">
      <PopoverPanel focus class="absolute inset-x-0 top-0 origin-top-right z-50 transform p-2 transition md:hidden">
          ...
          <div class="space-y-6 py-6 px-5">
            ...
            <div>
              ...
              <p class="mt-6 text-center text-base font-medium text-gray-500">
                Existing customer?
                {{ ' ' }}
                <a href="#" class="text-indigo-600 hover:text-indigo-500">Prihlásiť sa</a>
              </p>
            </div>
          </div>
        </div>
...
import {
  ...
  MenuButton,
  MenuItem,
  MenuItems, Popover, PopoverButton, PopoverGroup, PopoverPanel
} from "@headlessui/vue";
import {
  CalendarIcon,
  ChartBarIcon,
