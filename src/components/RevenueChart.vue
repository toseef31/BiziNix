<template>
  <div class="bg-[#00A6A6] p-4 shadow rounded-[1.25rem]">
    <div class="flex justify-between">
      <h2 class="text-xl font-bold mb-2 text-white">Tržba</h2>
    ...
    <div class="flex justify-between">
      <h1 class="text-3xl text-white mt-2">${{ actualYearData.profitSum }}</h1>
      <div>
        <p class="text-lg text-white mb-2">Tržba s DPH</p>
        <p class="text-lg text-white">$4811,21</p>
      </div>
      <div></div>
    </div>
    <LineChart :chartData="profitChartData" :chartOptions="chartOptions" style="height: 60%;" ref="lineChart" />
  </div>
</template>
