  ...
  <div>
    <div class="w-full min-h-[90vh] flex flex-row">
      ...
      <div v-if="!isLoading" class="flex flex-col w-full items-center">
        <div class="flex flex-col w-full py-8" v-if="!selectedCompany.ico || selectedCompany.ico == ''">
        ...
        <div class="flex flex-col w-full" v-else>
          ...
          <div class="flex flex-col w-full"
            v-else-if="selectedCompany.sidlo_typ_balika != null && selectedCompany.sidlo_typ_balika.toLowerCase() != 'mini'">
                        ...
                        <tbody class="divide-y divide-gray-200 bg-gray-50">
                          <tr v-for="mail in mails" :key="mail.id" :class="[mail.status == 1 && 'bg-white']">
                            <td class="relative w-12 px-6 sm:w-16 sm:px-8">
                              <div v-if="checkedMails.includes(mail)"
                            ...
                            <td class="whitespace-nowrap py-4 pl-3 pr-4 text-left text-sm font-medium sm:pr-6">
                              <div class="flex-1 py-4 px-3 text-left"
                                v-if="!mail.scan_requested && (mail.status == 2 || mail.status == 4)">
                                  ...
                                  <DialogPanel class="w-full max-w-lg rounded">
                                    <div class="bg-gray-700 bg-opacity-95 rounded-lg">
                                      ...
                                      <div class="flex flex-row justify-center pb-4 px-4 gap-8">
                                        <div class="flex flex-1/4">
                                          <button
                                            class="bg-gray-500 hover:bg-gray-800 h-10 px-8 rounded z-10 text-white"
                                        ...
                                        <div class="flex flex-1/4 px-4">
                                          <button
                                            class="bg-teal-500 hover:bg-teal-700 h-10 px-8 rounded z-10 text-white"
