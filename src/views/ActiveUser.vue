    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        <form class="space-y-6" @submit.prevent="login">
          <div v-if="sucessMessage" class="flex items-center justify-between py-3 px-4 bg-green-500 text-white rounded">
          {{ sucessMessage }}
          <span @click="sucessMessage=''" class="rounded-full transition-colors cursor-pointer hover:bg-[rgba(0,0,0,0.2)]">
