...
export default {
  ...
  global: {
    ...
    help: 'text-[13px] text-gray-500 font-normal',
  ...
  'family:box': {
    ...
    label: '$reset text-sm text-white mt-1 select-none',
    wrapper: 'flex items-center mb-1',
  },
  'family:button': {
    input: '$reset items-center w-full bg-teal-600 text-white text-sm font-normal py-3 px-6 rounded focus-visible:outline-2 focus-visible:outline-blue-600 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:inline-block formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin',
    wrapper: 'mb-1',
  ...
  'family:dropdown': {
    ...
    inner: 'max-w-full relative flex ring-1 ring-gray-400 focus-within:ring-teal-500 focus-within:ring-2 rounded mb-1 formkit-disabled:focus-within:ring-gray-400 formkit-disabled:focus-within:ring-1 [&>span:first-child]:focus-within:text-blue-500',
    input: 'w-full px-3 py-2',
    listbox: 'bg-gray-800 shadow-lg rounded overflow-hidden',
    listboxButton: 'flex w-12 self-stretch justify-center mx-auto',
    listitem: 'pl-7 relative hover:bg-gray-700 data-[is-active="true"]:bg-gray-700 data-[is-active="true"]:aria-selected:bg-teal-600 aria-selected:bg-teal-600 aria-selected:text-white',
    loaderIcon: 'ml-auto',
