...
const boxClassification = {
  ...
  help: 'mb-2',
  input:
    'form-check-input appearance-none h-5 w-5 mr-2 border border-gray-500 rounded-sm bg-white checked:bg-teal-500 focus:outline-none focus:ring-0 transition duration-200',
  label: 'text-sm text-gray-700 mt-1',
};
const buttonClassification = {
  wrapper: 'mb-1',
  input:
    'bg-teal-500 hover:bg-teal-700 text-white text-sm font-normal py-3 px-5 rounded',
};
...
export default {
  ...
  file: {
    ...
    input:
      'text-gray-600 text-sm mb-1 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:bg-teal-500 file:text-white hover:file:bg-teal-600',
    noFiles: 'block text-gray-800 text-sm mb-1',
    fileItem: 'block flex text-gray-800 text-sm mb-1',
    removeFiles: 'ml-auto text-teal-500 text-sm',
  },
